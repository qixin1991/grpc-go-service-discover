...
func (c *greeterClient) SayHelloAgain(ctx context.Context, in *HelloRequest, opts ...grpc.CallOption) (*HelloReply, error) {
	out := new(HelloReply)
	err := grpc.Invoke(ctx, "/rpc.Greeter/SayHelloAgain", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
var fileDescriptor0 = []byte{
	...
	0x1f, 0x8b, 0x08, 0x00, 0x00, 0x09, 0x6e, 0x88, 0x02, 0xff, 0xe2, 0xe2, 0xc8, 0x28, 0xd7, 0x2b,
	0x28, 0xca, 0x2f, 0xc9, 0x17, 0x62, 0x2e, 0x2a, 0x48, 0x56, 0x52, 0xe2, 0xe2, 0xf1, 0x48, 0xcd,
	...
	0x5c, 0xa3, 0x3c, 0x2e, 0x76, 0xf7, 0xa2, 0xd4, 0xd4, 0x92, 0xd4, 0x22, 0x21, 0x3d, 0x2e, 0x8e,
	0xe0, 0xc4, 0x4a, 0xb0, 0x2e, 0x21, 0x41, 0xbd, 0xa2, 0x82, 0x64, 0x3d, 0x64, 0x5b, 0xa4, 0xf8,
	0x91, 0x85, 0x40, 0x86, 0x1a, 0x73, 0xf1, 0xc2, 0xd4, 0x3b, 0xa6, 0x27, 0x66, 0xe6, 0x11, 0xa3,
	0x29, 0x89, 0x0d, 0xec, 0x0f, 0x63, 0x40, 0x00, 0x00, 0x00, 0xff, 0xff, 0x2f, 0x9d, 0xef, 0x7d,
	0xd3, 0x00, 0x00, 0x00,
}
